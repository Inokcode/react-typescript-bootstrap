...
const CreateNotes: React.FunctionComponent<ICreateNotesProps> = ({ notes, setNotes }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
        ...
        setError("");
        setNotes([...notes, { id: (new Date()).toString(), title: (titleRef.current as HTMLInputElement).value, text: (textRef.current as HTMLTextAreaElement).value, color: (colorRef.current as HTMLInputElement).value, date: (new Date()).toString() }]);
